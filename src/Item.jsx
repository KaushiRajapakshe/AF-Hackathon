    ...
    render() {
        return (
            <div>
                ...
                <div className={"abc"}>
                    <h1 style={{marginLeft:'100px'}}>Add Item</h1>
                    <form >
                        <table style={{marginLeft:'0px',paddingTop:'100px'}}>
                            ...
                            <tr style={{height:'8px'}}></tr>
                            <tr>
                                <td><input name="submit" type="submit" Value="Add Item" style={{width:'150px',height:'50px',backgroundColor:'#5f5e63',color:'white',borderRadius:'9px',marginTop:'10px',marginLeft:'60px'}}/></td>
                                <td><input name="submit" type="submit" Value="Update Item" style={{width:'150px',height:'50px',backgroundColor:'#5f5e63',color:'white',borderRadius:'9px',marginTop:'10px',marginLeft:'60px'}}/></td>
                            </tr>
