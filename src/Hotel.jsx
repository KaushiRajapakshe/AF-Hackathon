    ...
    render() {
        return (
            <div>
                ...
                <div className={"abc"}>
                    <h1 style={{marginLeft:'100px'}}>Add Hotel</h1>
                    <form >
                        <table style={{marginLeft:'0px',paddingTop:'100px'}}>
                            ...
                            <tr>
                                ...
                                <td><textarea name="hour" style={{width:'364px', height:'60px',paddingLeft:'16px',borderRadius:'5px',marginLeft:'55px'}}></textarea></td>
                            </tr>
                            <tr style={{height:'8px'}}></tr>
                            <tr>
